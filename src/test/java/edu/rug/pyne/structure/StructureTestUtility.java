...
public class StructureTestUtility {
    ...
    public void generateGraph() {
        ...
        VertexClass class4 = framedGraph.addFramedVertex(VertexClass.class, T.label, "class");
        ...
        method1.setArgumentTypes("String");
        ...
        method2.setArgumentTypes("String,int");
        ...
        method4.setArgumentTypes("String,Vertex");
